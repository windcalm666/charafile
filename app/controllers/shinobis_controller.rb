class ShinobisController < ApplicationController
  ...
  def shinobi_params
    ...
    :background_point_1, :background_point_2, :background_point_3, :background_point_4, :background_point_5, :background_point_6,
    :background_point_7, :background_point_8, :background_point_9, :background_point_10, :background_effect_1, :background_effect_2,
